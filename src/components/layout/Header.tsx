...
export function Header({ userName, variant = "default" }: HeaderProps) {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm h-16 px-3 md:px-6 flex items-center justify-between w-full">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
            ...
            <Link to="/dashboard" className="flex items-center min-w-0" aria-label="Ir para página inicial">
              <div className="flex items-center gap-2">
                <img 
                  ...
                  alt="EconoTrip"
                  className="h-8 w-8 md:h-9 md:w-9 rounded-lg flex-shrink-0 shadow-sm"
                />
        ...
        {isLoggedIn ? (
          ...
          <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
            <Link 
              to="/login" 
              className="text-econotrip-blue hover:text-econotrip-blue/80 font-medium text-sm md:text-base touch-target py-2 px-2 md:px-3 rounded-lg hover:bg-econotrip-blue/10 transition-colors"
            ...
            <Link 
              to="/registro"
              className="bg-gradient-to-r from-econotrip-orange to-econotrip-orange/90 hover:from-econotrip-orange/90 hover:to-econotrip-orange/80 text-white font-medium py-2 px-3 md:px-4 rounded-xl text-sm md:text-base touch-target whitespace-nowrap shadow-md hover:shadow-lg transition-all"
