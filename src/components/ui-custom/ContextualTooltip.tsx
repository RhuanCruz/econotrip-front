    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            type="button"
            className={`inline-flex items-center justify-center w-5 h-5 text-econotrip-blue hover:text-econotrip-orange transition-colors ${className}`}
            aria-label="Ajuda"
          >
            <HelpCircle className="h-4 w-4" />
          </button>
        </TooltipTrigger>
        <TooltipContent className="max-w-xs bg-white border border-gray-200 shadow-lg rounded-lg p-3">
...
Agora vou criar um componente de pop-up padronizado:

<lov-write file_path="src/components/ui-custom/StandardModal.tsx">
import React from "react";
