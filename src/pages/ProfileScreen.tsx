...
export default function ProfileScreen() {
  ...
  return (
    <motion.div 
      className="max-w-5xl mx-auto py-6 pb-24 relative"
    ...
    >
      ...
      <motion.div variants={itemAnimation}>
        <motion.div
          ...
          className="mb-8"
        >
          <Card className="p-6 rounded-2xl shadow-md border-econotrip-green bg-econotrip-green/5">
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Todos os detalhes da sua viagem</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </motion.div>
